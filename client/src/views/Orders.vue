...
export default {
  ...
  setup() {
    ...
    const loadOrders = async () => {
      ...
      // Submitted restock orders are user-created and intentionally shown
      // UNFILTERED by the global FilterBar (they are not warehouse/category-scoped).
      // A failure here must not break the main orders table above.
      try {
